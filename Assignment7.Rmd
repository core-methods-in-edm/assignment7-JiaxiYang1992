...
graphics::pairs(D1, labels=colnames(D1), main="Relationships")

#Try to capture an intution about the data and the relationships

# There seems to be postitive correlations among messages, post.test.score and average.assignment.score.
...
D1$pred <- predict(c.tree1,D1, type = "prob")[,2]#Last class we used type = "class" which predicted the classification for us, this time we are using type = "prob" to see the probability that our classififcation is based on.
...
# The AUC of the second model is much larger than that of the first model. Therefore, the second model is better.
...
# Sometimes a high kappa value can be misleading. 
# If the ROC curve is smooth enough, higher threshold will result in lower kappa.
